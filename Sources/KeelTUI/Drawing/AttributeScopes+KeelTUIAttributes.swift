...
extension AttributeScopes {
    public struct KeelTUIAttributes: AttributeScope {
...
@available(macOS 12, *)
extension AttributeScopes.KeelTUIAttributes {
...
public extension AttributeDynamicLookup {
  subscript<T: AttributedStringKey>(dynamicMember keyPath: KeyPath<AttributeScopes.KeelTUIAttributes, T>) -> T {
    self[T.self]
  }
}
