...
public enum TerminalDisplayWidth {
    ...
    public static func truncate(_ text: String, toWidth width: Int) -> String {
        guard width > 0 else {
            return ""
        }
    ...
    public static func padRight(_ text: String, toWidth width: Int) -> String {
        let truncated = truncate(text, toWidth: width)
